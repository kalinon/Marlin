...
#define STRING_CONFIG_H_AUTHOR "(Holden Omans, SKR-1.4-Turbo)" // Who made the changes.
...
#define MACHINE_UUID "DC79EB78-688B-453D-AF05-37A3B1B9CFEB"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -0.85 }
